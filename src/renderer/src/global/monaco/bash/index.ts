...
export const shLanguageDefinition: monaco.languages.IMonarchLanguage = {
  ...
  tokenizer: {
    root: [
      ...
      // Keywords
      [
        /\b(?:if|then|else|elif|fi|case|esac|for|while|until|do|done|in|function|return|exit|break|continue|shift|source|export|readonly|local|declare|typeset|unset|let|eval|exec|command|builtin|type|hash|alias|unalias|set|shopt|trap|wait|test|true|false|read|echo|printf|getopts)\b/,
        'keyword'
      ],
