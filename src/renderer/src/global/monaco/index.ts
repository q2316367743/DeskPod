...
import { registerBatLanguage } from '@/global/monaco/bat'
import { registerNginxLanguage } from '@/global/monaco/nginx'
import { registerPowerShellLanguage } from '@/global/monaco/ps1'
import { registerShLanguage } from '@/global/monaco/bash'

export type MonacoLanguage = string

export const getMonacoLanguages = (): MonacoLanguage[] => {
  const languages = monaco.languages.getLanguages()
  return languages.map((lang) => lang.id).slice(0, 30)
}
