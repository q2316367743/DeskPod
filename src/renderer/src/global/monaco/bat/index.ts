...
export const batLanguageDefinition: monaco.languages.IMonarchLanguage = {
  ...
  tokenizer: {
    root: [
      ...
      [
        /\b(?:if|else|not|exist|defined|errorlevel|equ|neq|lss|leq|gtr|geq|for|in|do|set|setlocal|endlocal|call|goto|exit|shift|choice|start|pushd|popd|cd|chdir|dir|copy|move|del|erase|ren|rename|md|mkdir|rd|rmdir|type|cls|pause|echo|title|color|prompt|rem|ver)\b/,
        'keyword'
      ],

      [
        /\b(?:attrib|assoc|bcdedit|bitsadmin|cacls|certutil|chcp|chkdsk|chkntfs|cipher|comp|compact|convert|diskpart|driverquery|fc|find|findstr|fltmc|fsutil|gpupdate|hostname|icacls|ipconfig|lodctr|logman|mklink|more|net|netsh|nslookup|pathping|ping|powercfg|qwinsta|query|reg|robocopy|route|sc|schtasks|setx|shutdown|sort|subst|systeminfo|taskkill|tasklist|timeout|tracert|tree|typeperf|verifier|wevtutil|whoami|wmic)\b/,
        'type.identifier'
      ],
