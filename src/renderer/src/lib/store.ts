...
class StoreWrapper {
  ...
  async save<T = unknown>(key: string, value: Array<T>) {
...
export class StoreEntry<T extends Record<string, unknown> = Record<string, unknown>> {
